...
### Requirements
- Windows 10 or 11
- Node.js (free): https://nodejs.org  ← don't be *sour*, download the "LTS" version!

### Steps
1. Extract this folder somewhere (e.g., Desktop... no *pressing* matters here).
2. Double-click **BUILD.bat** to start the magic.
3. Wait ~2 minutes for it to download and build (perfect time to grab a juice box!).
